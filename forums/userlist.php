...
$where_sql[] = 'u.group_id=6 or u.group_id=5';
}	 else {
...
$result = $db->query('SELECT g_id, g_title FROM '.$db->prefix.'groups WHERE g_id!='.PUN_GUEST.' AND g_id!=6 ORDER BY g_id') or error('Unable to fetch user group list', __FILE__, __LINE__, $db->error());
