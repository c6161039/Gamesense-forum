...
define('AJAX_CHAT_CHATBOT',		6);
define('AJAX_CHAT_BETA',		5);
define('AJAX_CHAT_PREMIUM',		4);
...
// Database type:
$config['dbConnection']['type'] = 'sqlite';
// Database link:
$config['dbConnection']['link'] = null;

// Database table names:
@include '../config.php'; // We have to include FluxBB's config file to get $db_prefix

if (empty($db_prefix)) // Let's do this to avoid a notice... :-(
	$prefix = null;
else
	$prefix = $db_prefix;

$config['dbTableNames'] = array();
$config['dbTableNames']['online']		= $prefix.'ajax_chat_online';
$config['dbTableNames']['messages']		= $prefix.'ajax_chat_messages';
$config['dbTableNames']['bans']			= $prefix.'ajax_chat_bans';
$config['dbTableNames']['invitations']	= $prefix.'ajax_chat_invitations';
...
// Available styles:
$config['styleAvailable'] = array('Cobalt','vBulletin');
// Default style:
...
$config['requestMessagesTimeDiff'] =  999999;
