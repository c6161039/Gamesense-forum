<head>
<title>Payments / skeet.rip</title>
</head>
<?php
...
$m->From( " gamesense Mailer;admin@gamesense.space" ); // от кого отправляется почта
...
$m->smtp_on("ssl://smtp.yandex.ru","admin@gamesense.space","", 465); //log, pass smtp
$m->Send();  
...
// $email = $_POST['email']; //get input text
 ...
 if($plan == 30){
	 $fu = $pun_user['email'];
	redirect("https://www.oplata.info/asp2/pay_payu.asp?id_d=1043802&id_po=0&cart_uid=&ai=&ae=&curr=PY1&lang=en-US&failpage=https%3A%2F%2Fwww%2Eoplata%2Einfo%2Fasp2%2Fpay_wm%2Easp%3Fid_d%3D1043802&_ow=&_ids_shop=&email=$fu", "Redirecting to the payment system");
	
 }

	//redirect("https://www.oplata.info/asp2/pay_payu.asp?id_d=1043802&id_po=0&cart_uid=&ai=&ae=&curr=PY1&lang=en-US&failpage=https%3A%2F%2Fwww%2Eoplata%2Einfo%2Fasp2%2Fpay_wm%2Easp%3Fid_d%3D1043802&_ow=&_ids_shop=", "Redirecting to the payment system");
...
<div id="brdmain">
<div class="blockform">
	<h2><span>Extend GameSense</span></h2>
	<div class="box">
...
echo format_time($datenow->getTimestamp(), false, null, null, false, true);	
								...
								<td>Charge</td>
								<td><?php 
if($item['goods'] == 1043802){
	echo "10.00$";
} elseif($item['goods'] == 10438021){
	echo "30.00$";
}elseif($item['goods'] == 10438021){
